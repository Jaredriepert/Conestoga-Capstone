...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, group1_a_Pin|group1_b_Pin|group2_a_Pin|group2_b_Pin
                          |group3_a_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2|DGT_POT_2_Pin|DGT_POT_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DGT_POT_3_GPIO_Port, DGT_POT_3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|GPIO_PIN_13, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(renamed___oops_GPIO_Port, renamed___oops_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, group3_b_Pin|group4_a_Pin|group4_b_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : group1_a_Pin group1_b_Pin group2_a_Pin group2_b_Pin
                           group3_a_Pin */
  GPIO_InitStruct.Pin = group1_a_Pin|group1_b_Pin|group2_a_Pin|group2_b_Pin
                          |group3_a_Pin;
  ...
  /*Configure GPIO pin : DGT_POT_3_Pin */
  GPIO_InitStruct.Pin = DGT_POT_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DGT_POT_3_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DGT_POT_2_Pin DGT_POT_1_Pin */
  GPIO_InitStruct.Pin = DGT_POT_2_Pin|DGT_POT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : FootSwitch1_Pin */
  GPIO_InitStruct.Pin = FootSwitch1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(FootSwitch1_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Foot2OLD_Pin Foot3OLD_Pin FootSwitch4_Pin */
  GPIO_InitStruct.Pin = Foot2OLD_Pin|Foot3OLD_Pin|FootSwitch4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : FootSwitch2_Pin FootSwitch3_Pin */
  GPIO_InitStruct.Pin = FootSwitch2_Pin|FootSwitch3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : renamed___oops_Pin */
  GPIO_InitStruct.Pin = renamed___oops_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(renamed___oops_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : group3_b_Pin group4_a_Pin group4_b_Pin */
  GPIO_InitStruct.Pin = group3_b_Pin|group4_a_Pin|group4_b_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
